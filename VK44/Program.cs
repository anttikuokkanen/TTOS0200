...
namespace JAMK.IT
{
    ...
    class Program
    {
        static void LueOhjastajatVer2()
        {
            try
            {
                //luetaan CSV-tiedostosta ja tallennetaan structeihin
                string erotin = ";";
                //luetaan kaikki rivit muuttujaan
                string[] rivit = System.IO.File.ReadAllLines(@"D:\K8183\tilasto2017.csv");
                Ohjastaja kuski;
                ...
                for (int i = 1; i < lkm; i++)
                {
                    ...
                    if (int.TryParse(sanat[2], out int apu))
                    {
                        ...
                        kuski.VoittoPros = (100F * kuski.Voitot / kuski.Startit); //kerrotaan 100F eli kerrotaan 100:lla liukulukuna
                    }
                    else
                    {
        ...
        static void LueOhjastajatVer1()
        {
            try
            {
                ...
                int counter = 1;
                string line;
                System.IO.StreamReader stream = new System.IO.StreamReader(@"D:\K8183\tilasto2017.txt");
        ...
        static void Main(string[] args)
        {
            ...
            catch (Exception ex)
            {
                ...
                //throw; tätä ei heitetä enää pääohjelmassa mihinkään,vaan näytetään virheviesti käyttäjälle
            }
        }
    }
}
